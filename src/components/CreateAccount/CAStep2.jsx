...
export default function CAStep2(props) {
    const handleSubmit = (event) => {
        event.preventDefault();
        const data = new FormData(event.currentTarget);
        var temp = props.data
        temp.FirstName = data.get("First Name")
        temp.LastName = data.get("Last Name")
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            name="First Name"
                                            autoComplete="name"
                                            defaultValue={props.data.FirstName !== "First Name" ? props.data.FirstName : null}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            id="LastName"
                                            autoComplete="name"
                                            defaultValue={props.data.LastName !== "Last Name" ? props.data.LastName : null}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            id="Email"
                                            autoComplete="Email"
                                            defaultValue={props.data.Email !== "Email" ? props.data.Email : null}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <FormControlLabel
