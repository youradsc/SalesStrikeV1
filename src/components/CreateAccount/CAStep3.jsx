...
export default function CAStep3(props) {
    const handleSubmit = (event) => {
        event.preventDefault();
        const data = new FormData(event.currentTarget);
        var temp = props.data
        temp.P31 = data.get(props.data.P31)
        temp.p32 = data.get(props.data.P32)
        props.setData(temp)
        console.log(temp)
        props.buttonf("Step4")
    };
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            fullWidth
                                            id={props.data.P31}
                                            label={props.data.P31}
                                            name={props.data.P31}
                                            defaultValue={props.data.P31}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            fullWidth
                                            name={props.data.P32}
                                            label={props.data.P32}
                                            id={props.data.P32}
                                            autoComplete={props.data.P31}
                                            defaultValue={props.data.P32}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <FormControlLabel
